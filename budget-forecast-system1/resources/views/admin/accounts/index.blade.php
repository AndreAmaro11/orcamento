                                ...
                                @forelse ($accounts as $account)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route("accounts.edit", $account) }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-200 mr-3">Editar</a>
                                            <form action="{{ route("accounts.destroy", $account) }}" method="POST" class="inline-block" onsubmit="return confirm("Tem certeza que deseja excluir esta conta?");">
                                                @csrf
                                                @method("DELETE")
