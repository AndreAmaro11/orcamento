<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __("Editar Centro de Custo: ") . $costCenter->name }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route("cost-centers.update", $costCenter) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="code" class="block mt-1 w-full" type="text" name="code" :value="old("code", $costCenter->code)" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old("name", $costCenter->name)" required />
